...
- Copy: the offer highlights the verified 20-domain limit, catch-all inbound behavior, and AI triage/drafts/reports without overstating mailbox provisioning.
